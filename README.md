...
![First 200 cleared rows for an optimized weight](https://github.com/corentinpla/Learning-Tetris-Using-the-Noisy-Cross-Entropy-Method/blob/main/first_200.gif)
# Optimizer
## Cross entropy 
